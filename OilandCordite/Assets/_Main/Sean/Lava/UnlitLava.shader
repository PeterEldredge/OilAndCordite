    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 frag (v2f i) : SV_Target
            {
                ...
                col +=  (surfaceNoiseCutoff * gritNoise * _CutoffMultiplier);

                float4 surfaceNoise = col.r > 0 ? lerp(_LavaInnerColor, _LavaEdgeColor, gritNoise) : _LavaCooledColor * gritNoise;
